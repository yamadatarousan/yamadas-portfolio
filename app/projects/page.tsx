        ...
        {technologies.map(
          (tech: {
            ...
            <Link
              ...
              style={{
                backgroundColor:
                  selectedTech === tech.slug ? tech.color : undefined,
                borderColor:
                  selectedTech === tech.slug ? tech.color : undefined,
              }}
            >
  ...
  return (
    <div className='min-h-screen bg-gray-50 dark:bg-gray-900 py-8'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <Suspense
          fallback={
            <div className='h-24 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse mb-8' />
          }
        >
          <ProjectStats />
        </Suspense>
        ...
        <Suspense
          fallback={
            <div className='h-16 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse mb-8' />
          }
        >
